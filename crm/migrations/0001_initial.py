# -*- coding: utf-8 -*-
# Generated by Django 1.11.11 on 2018-05-11 14:35
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=32, verbose_name='课程民称')),
            ],
        ),
        migrations.CreateModel(
            name='CourseRecord',
            fields=[
                ...
                ('exam', models.TextField(blank=True, max_length=500, null=True, verbose_name='采分点')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('qq', models.CharField(help_text='QQ号必须唯一', max_length=32, unique=True, verbose_name='qq')),
                ...
                ('major', models.CharField(blank='True', max_length=32, null=True, verbose_name='所属专业')),
                ...
                ('status', models.IntegerField(choices=[(1, '已报名'), (2, '未报名')], default=2, help_text='选择客户此时的状态', verbose_name='客户状态')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('position', models.CharField(blank=True, max_length=32, null=True, verbose_name='岗位')),
                ('salary', models.IntegerField(blank=True, null=True, verbose_name='薪资')),
                ('welfare', models.CharField(blank=True, max_length=128, null=True, verbose_name='福利')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('record', models.CharField(choices=[('checked', '已签到'), ('vacate', '请假'), ('late', '迟到'), ('noshow', '缺勤'), ('leave_early', '早退')], default='checked', max_length=32, verbose_name='上课记录')),
                ('score', models.IntegerField(choices=[(100, 'A+'), (90, 'A'), (85, 'B+'), (80, 'B'), (70, 'B-'), (60, 'C+'), (50, 'C'), (40, 'C-'), (0, ' D'), (-1, 'N/A'), (-100, 'COPY'), (-1000, 'FAIL')], default=-1, verbose_name='本次成绩')),
                ('homework_note', models.CharField(blank=True, max_length=500, null=True, verbose_name='作业评语')),
        ...
        migrations.AddField(
            model_name='classlist',
            name='teachers',
            field=models.ManyToManyField(related_name='teachers', to='crm.UserInfo', verbose_name='任课老师'),
        ),
        migrations.AddField(
            model_name='classlist',
            name='tutor',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tutor', to='crm.UserInfo', verbose_name='班主任'),
        ),
    ]
